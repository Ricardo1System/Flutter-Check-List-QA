...
final moduleListProvider = StateNotifierProvider.family<ModuleListNotifier, List<Module>, ProjectModel>((ref, project) {
  ...
  return ModuleListNotifier(project, addModuleUseCase, updateModuleUseCase, deleteModuleUseCase);
});
...
class ModuleListNotifier extends StateNotifier<List<Module>> {
  ...
  ModuleListNotifier(this._project, this._addModule, this._updateModule, this._deleteModule)
